      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3">
              <Image src="/logo.png" alt="Al-Xorazmiy Olimpiadasi" width={44} height={44} className="rounded-lg" />
              <div>
                <p className="font-semibold text-foreground text-sm sm:text-base">Al-Xorazmiy Olimpiadasi</p>
              </div>
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Al-Xorazmiy universiteti tomonidan tashkil etilgan respublika miqyosidagi olimpiada.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+998556020002" className="hover:text-foreground transition-colors">
                  +998 (55) 602-00-02
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 flex-shrink-0" />
                <a href="mailto:info@akhu.uz" className="hover:text-foreground transition-colors">
                  info@akhu.uz
                </a>
              </div>
            </div>
        ...
        <div className="mt-8 pt-6 sm:pt-8 border-t border-border text-center space-y-2">
          <p className="text-xs sm:text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Al-Xorazmiy Olimpiadasi. Barcha huquqlar himoyalangan.
          </p>
